...
public class FacilitiesAdapter extends ArrayAdapter<Facility> {
  ...
  public View getView(int position, View view, ViewGroup parent) {
    ...
    Bitmap bm =
        BitmapFactory.decodeResource(fragment.getResources(), facility.getFacilityBitMapId());
  ...
  static class ViewHolder {
    @InjectView(R.id.ivFacilitiesDetailImg) ImageView ivFacilitiesDetailImg;
    @InjectView(R.id.txFacilitiesDetailLabel) TextView txFacilitiesDetailLabel;
