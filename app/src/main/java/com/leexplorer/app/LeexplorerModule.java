...
@Module(
        injects = {
                ...
                BeaconScanService.class, ArtworkAdapter.class, GalleryAdapter.class, GalleryPagerAdapter.class,
                GalleryInfoAdapter.class, GalleryMapFragment.class
        },
        library = true)
public class LeexplorerModule {
    ...
    @Provides
    @Singleton
    Client provideLeexplorerClient(OkHttpClient client) {
